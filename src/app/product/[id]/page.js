...
const products = [
  {
    ...
    category: "Fruits",
    description: "Fresh organic bananas sourced directly from organic farms. Rich in potassium and perfect for a healthy snack or breakfast.",
    nutritionFacts: {
      calories: 105,
      protein: "1.3g",
      carbs: "27g",
  ...
  },
  {
    ...
    gallery: [
      "/images/strawberrybucket.jpg",
      "/images/strawberrybucket.jpg"
    ],
    category: "Fruits",
    description: "Sweet and juicy strawberries, perfect for desserts or as a healthy snack. Packed with vitamin C and antioxidants.",
    nutritionFacts: {
      calories: 32,
      protein: "0.7g",
      carbs: "7.7g",
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <nav className="mb-8 ">
        <ol className="flex flex-wrap items-center text-sm">
          <li className="flex items-center">
            <Link href="/" className="text-gray-500 text-white hover:text-primary">Home</Link>
            <span className="mx-2 text-gray-400">/</span>
          </li>
          <li className="flex items-center">
            <Link href={`/category/${product.category.toLowerCase()}`} className="text-gray-500 hover:text-primary">
              {product.category}
            </Link>
            <span className="mx-2 text-gray-400">/</span>
          </li>
        ...
        >
          ...
          <div className="border-t border-b border-gray-200 py-4 mb-6">
            ...
            <div className="flex items-center text-sm text-gray-600">
              ...
              <span>{product.sold}+ {product.unit}s</span>
            </div>
          </div>
      ...
      <div className="py-8">
        ...
        {activeTab === 'nutrition' && (
          ...
          >
            <h3 className="text-lg font-bold mb-4">Nutrition Facts (per 100g)</h3>
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
              <div className="border border-gray-200 rounded-lg p-4 text-center">
                <p className="text-gray-500 text-sm">Calories</p>
                <p className="font-bold text-lg">{product.nutritionFacts.calories}</p>
              </div>
              <div className="border border-gray-200 rounded-lg p-4 text-center">
                <p className="text-gray-500 text-sm">Protein</p>
                <p className="font-bold text-lg">{product.nutritionFacts.protein}</p>
              </div>
              <div className="border border-gray-200 rounded-lg p-4 text-center">
                <p className="text-gray-500 text-sm">Carbs</p>
                <p className="font-bold text-lg">{product.nutritionFacts.carbs}</p>
              </div>
              <div className="border border-gray-200 rounded-lg p-4 text-center">
                <p className="text-gray-500 text-sm">Fat</p>
                <p className="font-bold text-lg">{product.nutritionFacts.fat}</p>
              </div>
              <div className="border border-gray-200 rounded-lg p-4 text-center">
                <p className="text-gray-500 text-sm">Fiber</p>
                <p className="font-bold text-lg">{product.nutritionFacts.fiber}</p>
              </div>
            </div>
          </motion.div>
        )}
        ...
        {activeTab === 'reviews' && (
          ...
          >
            ...
            <div className="text-center py-12">
              <p className="text-gray-500">This is where customer reviews would appear. In a real app, you would fetch and display actual reviews here.</p>
            </div>
          </motion.div>
        )}
      </div>
