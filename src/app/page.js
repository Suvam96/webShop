...
export default function Home() {
  ...
  const popularCategories = [
    ...
    { id: 3, name: "Dairy", image: "/images/dairy.png", count: 28 },
    { id: 4, name: "Bakery", image: "/images/backery.jpg", count: 36 },
    { id: 5, name: "Beverages", image: "/images/bevrage.png", count: 51 },
    { id: 6, name: "Snacks", image: "/images/snacks.png", count: 49 },
  ];
            ...
            <div className="flex flex-col md:flex-row items-center">
              <div className="md:w-1/2 p-8">
                ...
                <p className="text-white text-lg mb-6">
                  Get 30% off on your first order. Use code: WEBSHOP30
                </p>
                <a
                  href="/products"
