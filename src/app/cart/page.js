      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        >
                      ...
                      <div className="flex items-center">
                        ...
                        <button
                          ...
                          className={`p-1 border border-gray-300 rounded-r ${
                            item.quantity >= item.stock ? 'bg-gray-100 text-gray-400' : 'bg-white text-gray-600 hover:bg-gray-50'
                          }`}
                        >
                          <FaPlus size={10} />
                        </button>
          ...
          <div className="mt-6 flex justify-between">
            <Link href="/" className="flex text-white items-center text-primary hover:underline">
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <div className="mt-6">
              ...
              <div className="flex space-x-2">
                <div className="bg-gray-200 rounded p-2 w-12 h-8"></div>
                <div className="bg-gray-200 rounded p-2 w-12 h-8"></div>
                <div className="bg-gray-200 rounded p-2 w-12 h-8"></div>
                <div className="bg-gray-200 rounded p-2 w-12 h-8"></div>
              </div>
